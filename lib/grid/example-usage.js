 ...
 */
import { fetchGridState, pushPointerEvent, checkHealth, renderGrid, renderGridEmbed, } from './index.js';
// ═══════════════════════════════════════════════════════════════
// Example 1: Simple Grid Display Command
// ═══════════════════════════════════════════════════════════════
export async function handleGridCommand() {
...
// ═══════════════════════════════════════════════════════════════
export async function handleGridEmbedCommand(recentEvents) {
    // Fetch current grid state
    const cellPressures = await fetchGridState();
    // Create embed data
...
// ═══════════════════════════════════════════════════════════════
export async function recordBotAction(cellId, action, metadata) {
...
// ═══════════════════════════════════════════════════════════════
export async function ensureApiHealth() {
...
// ═══════════════════════════════════════════════════════════════
export async function getCellPressure(cellId) {
    const cellPressures = await fetchGridState();
...
// ═══════════════════════════════════════════════════════════════
export async function getGridStatusMessage() {
    const cellPressures = await fetchGridState();
    // Find hottest cell
    let hottestCell = 'A1';
    let maxPressure = 0;
