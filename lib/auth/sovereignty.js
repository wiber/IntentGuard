 ...
 */
export function calculateRawSovereignty(trustDebtUnits) {
 ...
 */
export function applyDriftReduction(rawSovereignty, driftEvents) {
    if (driftEvents === 0)
        return rawSovereignty;
 ...
 */
export function unitsToGrade(units) {
    if (units <= GRADE_BOUNDARIES.A.max)
        return 'A';
    if (units <= GRADE_BOUNDARIES.B.max)
        return 'B';
    if (units <= GRADE_BOUNDARIES.C.max)
        return 'C';
    return 'D';
}
 ...
 */
export function extractCategoryScores(categoryPerformance) {
    const scores = {};
 ...
 */
export function calculateSovereignty(trustDebtStats, driftEvents = 0) {
 ...
 */
export function countDriftEvents(since) {
 ...
 */
export function recordDriftEvent(event) {
 ...
 */
export function driftEventsUntilZero(currentSovereignty) {
    if (currentSovereignty <= 0)
        return 0;
 ...
 */
export function calculateRecoveryPath(currentUnits, driftEvents) {
    const milestones = [];
