...
export { 
// Constants
TRUST_DEBT_CATEGORIES, DEFAULT_REQUIREMENTS, 
// Vector Operations (20-dimensional math)
identityToVector, requirementToVector, dotProduct, magnitude, cosineSimilarity, 
// Overlap Computation
...
checkPermission, 
// Identity Loading
loadIdentityFromPipeline, getRequirement, } from './geometric.js';
// ═══════════════════════════════════════════════════════════════════════════
...
ACTION_MAP, 
// Lookup Functions
getActionRequirement, hasActionRequirement, getAllToolNames, getAllRequirements, getActionsBySovereignty, getActionsByCategory, 
// Risk Levels
getRiskLevel, 
// Constants
DEFAULT_OVERLAP_THRESHOLD, SOVEREIGNTY_LEVELS, } from './action-map.js';
// ═══════════════════════════════════════════════════════════════════════════
// Sovereignty Score Calculation (sovereignty.ts)
// ═══════════════════════════════════════════════════════════════════════════
export { 
// Core Calculation
calculateSovereignty, calculateRawSovereignty, applyDriftReduction, 
// Grade Mapping
unitsToGrade, 
// Category Score Extraction
extractCategoryScores, 
// Drift Event Tracking
countDriftEvents, recordDriftEvent, 
// Forecasting & Recovery
driftEventsUntilZero, calculateRecoveryPath, 
// Constants
K_E, MAX_TRUST_DEBT_UNITS, GRADE_BOUNDARIES, } from './sovereignty.js';
// ═══════════════════════════════════════════════════════════════════════════
// Identity Vector Loading (identity-vector.ts)
// ═══════════════════════════════════════════════════════════════════════════
export { 
// Load Functions
loadIdentityVector, loadIdentityVectorDefault, 
// Conversion Utilities
normalizeRawVector, vectorToRaw, 
// Cache Management
clearCache, getCacheStats, } from './identity-vector.js';
// ═══════════════════════════════════════════════════════════════════════════
...
export { 
// Interceptor Class
FimInterceptor, } from './fim-interceptor.js';
// ═══════════════════════════════════════════════════════════════════════════
// Audit Logging (audit-logger.ts)
// ═══════════════════════════════════════════════════════════════════════════
export { 
// Audit Logger Class (named FimAuditLogger in source)
FimAuditLogger as AuditLogger, } from './audit-logger.js';
// ═══════════════════════════════════════════════════════════════════════════
// OpenClaw Plugin Generation (plugin.ts)
// ═══════════════════════════════════════════════════════════════════════════
export { 
// Plugin Functions
generatePluginCode as generateFimPlugin, installPlugin as installFimPlugin, getDefaultPluginDir, } from './plugin.js';
// ═══════════════════════════════════════════════════════════════════════════
