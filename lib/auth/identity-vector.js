 ...
 * ```
 */
export function loadIdentityVector(step4Path, userId = 'system') {
    // Check cache first
 ...
 * ```
 */
export function loadIdentityVectorDefault(userId = 'system') {
    const possiblePaths = [
 ...
 * ```
 */
export function normalizeRawVector(rawVector, userId = 'system') {
 ...
 * ```
 */
export function vectorToRaw(vector) {
...
//# sourceMappingURL=identity-vector.js.map