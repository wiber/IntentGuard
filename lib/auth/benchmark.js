 ...
 */
import { computeOverlap, checkPermission, TRUST_DEBT_CATEGORIES, } from './geometric.js';
// ─── Test Data Generation ───────────────────────────────────────────────
/**
 * Generate a realistic identity vector with random scores.
 */
function generateIdentity(userId = 'benchmark-user') {
 ...
 */
function generateRequirement(toolName, numCategories) {
 ...
 */
function runBenchmark(testName, iterations, identities, requirements) {
    const latencies = [];
