 ...
 */
export function identityToVector(identity) {
 ...
 * Missing categories default to 0.0.
 */
export function requirementToVector(requirement) {
 ...
 */
export function computeOverlap(identity, requirement) {
 ...
 */
export function computeOverlapThreshold(identity, requirement) {
    const entries = Object.entries(requirement.requiredScores);
    if (entries.length === 0)
        return 1.0;
    let met = 0;
 ...
 */
export function checkPermission(identity, requirement, threshold = 0.8) {
...
export function getRequirement(toolName) {
 ...
 */
export function loadIdentityFromPipeline(pipelineDir, userId = 'default') {
    try {
