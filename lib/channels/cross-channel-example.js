...
export async function setupCrossChannelRouting(client, channelManager, log) {
    ...
    //   }
    // });
    const forwardToExternalChannels = async (room, content, author) => {
    ...
    channelManager.forwardToExternalChannels = forwardToExternalChannels;
 ...
 */
export function addWhatsAppMapping(channelManager, groupId, room) {
    const adapters = channelManager.getAdapters();
 ...
 */
export function addTelegramMapping(channelManager, groupId, room) {
    const adapters = channelManager.getAdapters();
    const telegramAdapter = adapters.get('telegram');
    if (!telegramAdapter) {
...
//# sourceMappingURL=cross-channel-example.js.map