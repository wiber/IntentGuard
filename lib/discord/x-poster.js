...
export class XPoster {
     ...
     */
    setDiscord(discord, xPostsChannelId) {
     ...
     */
    async post(text, discordMessageId) {
     ...
     */
    async postViaClaudeFlowShell(text) {
...
//# sourceMappingURL=x-poster.js.map