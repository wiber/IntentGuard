 ...
 */
import { FederationHandshake, computeTensorOverlap, isCompatible, } from './index';
...
const botA_handshake = new FederationHandshake('bot-dev-001', 'Local Development Bot', botA_geometry, './data-example');
