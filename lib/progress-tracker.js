...
export default class ProgressTracker {
    ...
    constructor(specPath) {
        this.specPath = specPath || path.join(__dirname, '..', 'spec', 'sections', '08-implementation-plan.tsx');
    }
    /**
    ...
    formatForDiscord() {
        ...
        lines.push('');
        // Header
        lines.push(this.padRight('Phase', 35) +
            this.padLeft('Done', 6) +
            this.padLeft('WIP', 6) +
            this.padLeft('Todo', 6) +
        ...
        for (const phase of report.phases) {
            ...
            lines.push(this.padRight(name, 35) +
        ...
        // Footer
        lines.push('-'.repeat(70));
        lines.push(this.padRight('TOTAL', 35) +
