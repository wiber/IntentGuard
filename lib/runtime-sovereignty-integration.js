 ...
 */
export function initializeSovereigntyMonitor(log, artifactGenerator, discordNotify) {
 ...
 * @param log - Logger instance
 */
export function recordSovereigntyFromPipeline(monitor, log) {
 ...
 */
export async function handleStabilityCheck(monitor, log) {
 ...
 */
export function getSovereigntyStatus(monitor) {
 ...
 */
export async function generateStabilityArtifact(userId, score, stableDays) {
 ...
 */
export async function sendStabilityNotification(message) {
...
//# sourceMappingURL=runtime-sovereignty-integration.js.map