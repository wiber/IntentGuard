 ...
 */
export function saveArtifactSnapshot(mesh) {
    ensureArtifactsDir();
 ...
 */
export function loadArtifactSnapshot(timestamp) {
    ensureArtifactsDir();
 ...
 */
export function listArtifactSnapshots() {
    ensureArtifactsDir();
 ...
 */
function computeGeometricDistance(vertices1, vertices2) {
 ...
 */
export function compareArtifacts(snapshot1, snapshot2) {
    ...
    const geometricDistance = computeGeometricDistance(snapshot1.mesh.vertices, snapshot2.mesh.vertices);
 ...
 */
export function generateAsciiDiff(snapshot1, snapshot2) {
    const width = 20;
    const height = 12;
 ...
 */
function projectToGrid(vertices, width, height) {
 ...
 */
export function getArtifactHistory(limit = 10) {
 ...
 */
export function compareAgainstHistory(currentMesh) {
...
//# sourceMappingURL=artifact-comparison.js.map