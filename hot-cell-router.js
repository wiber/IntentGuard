...
exports.hotCellRouter = exports.HotCellRouter = void 0;
...
class HotCellRouter {
    constructor(eventsPath) {
        this.cellPressures = new Map();
        this.eventsPath = eventsPath || (0, path_1.join)(process.cwd(), 'data', 'grid-events.jsonl');
    }
    /**
     * Load events from JSONL file
     */
    loadEvents() {
        if (!(0, fs_1.existsSync)(this.eventsPath)) {
            return [];
        }
        try {
            const content = (0, fs_1.readFileSync)(this.eventsPath, 'utf8');
...
exports.HotCellRouter = HotCellRouter;
/**
 * Singleton instance for easy import
 */
exports.hotCellRouter = new HotCellRouter();
