...
export const tileMappings: TileMapping[] = [
  ...
  { tile: 'B1', gridName: 'Tactics.Speed', categories: 'adaptability, reliability', primaryRoom: 'voice' },
  { tile: 'B2', gridName: 'Tactics.Deal', categories: 'communication, collaboration, user_focus', primaryRoom: 'network' },
  { tile: 'B3', gridName: 'Tactics.Signal', categories: 'transparency, ethical_alignment', primaryRoom: 'navigator' },
