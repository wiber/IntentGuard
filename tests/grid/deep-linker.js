...
exports.ROOM_TO_CELLS = exports.CELL_NAMES = exports.deepLinker = exports.DeepLinker = void 0;
/**
...
class DeepLinker {
    tesseractBaseUrl;
    discordBaseUrl;
    constructor(tesseractBaseUrl = 'https://tesseract.nu', discordBaseUrl = 'https://discord.com/channels') {
     ...
     */
    generateDiscordLink(cell, messageId, channelId, guildId) {
        if (!messageId) {
     ...
     */
    generateComparisonLink(cells, mode = 'overlay') {
        const params = new URLSearchParams();
     ...
     */
    generateTimelineLink(cell, startTime, endTime) {
     ...
     */
    generateEmbedData(cell, context) {
        const cellNames = {
            A1: 'Law',
            A2: 'Goal',
            A3: 'Fund',
 ...
 */
exports.deepLinker = new DeepLinker();
/**
