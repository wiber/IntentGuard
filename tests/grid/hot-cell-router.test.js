/**
 * hot-cell-router.test.js — Tests for HotCellRouter
 *
 * Tests pressure calculation, hot cell detection, and room routing logic.
 */

const { HotCellRouter } = require('./hot-cell-router');
 ...
 */
function writeEventsToFile(events, path) {
...
describe('HotCellRouter', () => {
  ...
  describe('hot cell detection', () => {
    ...
    it('should return empty array when no cells meet threshold', () => {
      ...
      router.updatePressures(events);
      const hotCells = router.getHotCells(1.01); // Threshold above maximum possible (1.0)
  ...
  describe('time-weighted scoring', () => {
    ...
    it('should weight medium events (6 hours) at 0.5', () => {
      ...
      const pressureA1 = router.getCellPressure('A1').pressure;
      const pressureB2 = router.getCellPressure('B2').pressure;
