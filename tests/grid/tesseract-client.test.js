/**
 * tesseract-client.test.js — Tests for tesseract.nu HTTP Client
 *
...
import {
  ...
  checkHealth,
  getApiUrl,
} from '../../src/grid/tesseract-client';
...
describe('fetchGridState', () => {
  it('should fetch grid state successfully', async () => {
    const mockGridState = {
      cellPressures: {
        A1: 0.8, A2: 0.6, A3: 0.4, A4: 0.2,
        B1: 0.9, B2: 0.7, B3: 0.5, B4: 0.3,
        C1: 1.0, C2: 0.8, C3: 0.6, C4: 0.4,
      },
