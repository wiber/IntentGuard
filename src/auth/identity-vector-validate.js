 ...
 * Run with: node src/auth/identity-vector-validate.js
 */

const { loadIdentityVector, normalizeRawVector, vectorToRaw, getCacheStats } = require('./identity-vector.js');
const { TRUST_DEBT_CATEGORIES } = require('./geometric.js');
...
try {
  const step4Path = path.join(process.cwd(), '4-grades-statistics.json');
