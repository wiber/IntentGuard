...
const CATEGORIES = [
  ...
  { id: 'A1', name: 'Strategy.Law', emoji: '⚖️', tier: 'strategic' },
  { id: 'A2', name: 'Strategy.Goal', emoji: '🎯', tier: 'strategic' },
  { id: 'A3', name: 'Strategy.Fund', emoji: '💰', tier: 'strategic' },
  { id: 'B1', name: 'Tactics.Speed', emoji: '🏎️', tier: 'tactical' },
  { id: 'B2', name: 'Tactics.Deal', emoji: '🤝', tier: 'tactical' },
  { id: 'B3', name: 'Tactics.Signal', emoji: '📡', tier: 'tactical' },
  { id: 'C1', name: 'Operations.Grid', emoji: '🔌', tier: 'operational' },
  { id: 'C2', name: 'Operations.Loop', emoji: '🔄', tier: 'operational' },
  { id: 'C3', name: 'Operations.Flow', emoji: '🌊', tier: 'operational' },
