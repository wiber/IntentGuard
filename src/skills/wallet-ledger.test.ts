/**
 * src/skills/wallet-ledger.test.ts — Comprehensive tests for WalletLedger
 *
 * Tests cover:
...
describe('WalletLedger', () => {
  ...
  describe('JSONL Append-Only Transaction Log', () => {
    it('should create ledger file on initialization', () => {
      const ledgerPath = ledger.getLedgerPath();
      expect(fs.existsSync(ledgerPath)).toBe(true);
    });

    it('should append transactions in JSONL format', () => {
    ...
    it('should preserve append-only property', () => {
    ...
    it('should store timestamps in ISO format', () => {
  ...
  describe('Balance Calculations', () => {
    it('should calculate balance correctly with no transactions', () => {
      expect(ledger.getBalance()).toBe(0);
    });

    it('should calculate balance with income only', () => {
    ...
    it('should calculate balance with expenses only', () => {
  ...
  describe('FIM Sovereignty-Based Spending Limits', () => {
    it('should return $100 daily limit for high sovereignty (>0.9)', () => {
    ...
    it('should return $50 daily limit for moderate sovereignty (>0.7)', () => {
    ...
    it('should return $20 daily limit for low sovereignty (>0.5)', () => {
      const alert = ledger.checkBudgetAlert(0.6);
      expect(alert.limit).toBe(20);
    });

    it('should return $5 daily limit for restricted sovereignty (<=0.5)', () => {
      const alert = ledger.checkBudgetAlert(0.4);
      expect(alert.limit).toBe(5);
    });

    it('should trigger alert when limit exceeded', () => {
    ...
    it('should not trigger alert when under limit', () => {
    ...
    it('should only count today\'s spending', () => {
  ...
  describe('Daily P&L Reports', () => {
    ...
    it('should return 0 for days with no transactions', () => {
      const randomDay = new Date('2025-01-15');
      const pnl = ledger.getDailyPnL(randomDay);
      expect(pnl).toBe(0);
    });

    it('should only include transactions from specified date', () => {
      const today = new Date();
  ...
  describe('Weekly P&L Reports', () => {
    it('should calculate weekly P&L for last 7 days', () => {
  ...
  describe('Inference Cost Tracking', () => {
    ...
    it('should track API inference costs as expenses', () => {
    ...
    it('should not log Ollama costs (free)', () => {
    ...
    it('should batch multiple inference costs', () => {
  ...
  describe('Transaction Retrieval', () => {
    it('should retrieve all transactions in order', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle negative amounts (logged as-is, not validated)', () => {
    ...
    it('should handle sovereignty edge values', () => {
