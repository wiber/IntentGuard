 ...
 */
function createIcosahedron(): { vertices: Vector3[]; faces: Face[] } {
 ...
 */
function subdivideMesh(vertices: Vector3[], faces: Face[]): { vertices: Vector3[]; faces: Face[] } {
 ...
 */
export function sovereigntyToMesh(
  identityVector: number[],
  sovereignty: number,
): MeshData {
 ...
 */
export function generateAsciiPreview(mesh: MeshData): string {
  const width = 40;
  const height = 20;
