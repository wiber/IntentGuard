 ...
 */
export function computeTensorOverlap(
  geometryA: Partial<Record<TrustDebtCategory, number>> | number[],
  geometryB: Partial<Record<TrustDebtCategory, number>> | number[],
): TensorOverlapResult {
 ...
 */
export function geometryHash(
  geometry: Partial<Record<TrustDebtCategory, number>> | number[],
): string {
